...
6. Array static methods: `binarySearch(A, 42)`, `copyOf(A)`, `sort(A)`.

7. String methods: `charAt(1)`, `indexOf('A')`, `replace('a', 'A')`, `replace("a", "abc")`, `substring(1,4)`, `toCharArray()`, `toLowerCase()`
